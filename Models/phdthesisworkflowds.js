...
const phdThesisWorkflowSchema = new mongoose.Schema(
  {
...
phdThesisWorkflowSchema.index({ colid: 1, programcode: 1, level: 1 });

module.exports = mongoose.models.phdthesisworkflowds || mongoose.model("phdthesisworkflowds", phdThesisWorkflowSchema);
