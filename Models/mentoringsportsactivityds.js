...
const mentoringSportsActivitySchema = new mongoose.Schema({
...
mentoringSportsActivitySchema.index({ colid: 1, regno: 1, activitydate: -1 });

module.exports = mongoose.models.mentoringsportsactivityds
  || mongoose.model("mentoringsportsactivityds", mentoringSportsActivitySchema);
