...
const placementNewPlacementApplicationSchema = new mongoose.Schema(
  {
...
placementNewPlacementApplicationSchema.index({ colid: 1, jobid: 1, regno: 1, studentemail: 1 }, { unique: true });

module.exports = mongoose.models.placementnewplacementapplicationds || mongoose.model("placementnewplacementapplicationds", placementNewPlacementApplicationSchema);
