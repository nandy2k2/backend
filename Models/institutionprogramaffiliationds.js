...
const institutionProgramAffiliationSchema = new mongoose.Schema({
  ...
  ordinance: { type: String, trim: true, required: true },
...
module.exports = mongoose.models.institutionprogramaffiliationds || mongoose.model("institutionprogramaffiliationds", institutionProgramAffiliationSchema);
