...
const phdNocWorkflowSchema = new mongoose.Schema(
  {
...
phdNocWorkflowSchema.index({ colid: 1, programcode: 1, level: 1 });

module.exports = mongoose.models.phdnocworkflowds || mongoose.model("phdnocworkflowds", phdNocWorkflowSchema);
