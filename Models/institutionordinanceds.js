...
const institutionOrdinanceSchema = new mongoose.Schema({
...
module.exports = mongoose.models.institutionordinanceds || mongoose.model("institutionordinanceds", institutionOrdinanceSchema);
