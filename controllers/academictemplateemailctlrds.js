...
const catalog = [
  ...
  row("Academic configuration", "regulation-course-map", "Regulation course map", ["academicyear", "regulation", "program", "programcode", "semester", "course", "coursecode", "coursetype", "credits", "faculty", "institution", "department", "status"], { academicyear: "2026-27", regulation: "R2026", program: "B.Tech", programcode: "BT001", semester: "1", course: "Programming", coursecode: "CS101", coursetype: "Theory", credits: "4", faculty: "Engineering", institution: "Main Institute", department: "Computer Science", status: "Active" }),
  ...
  row("User management", "student-data-upload", "Student data upload", ["name", "email", "phone", "password", "role", "regno", "academicyear", "admissionyear", "regulation", "program", "programcode", "semester", "section", "fathername", "mothername", "dateofbirth", "category", "gender", "nationality", "address", "state", "pincode", "googleemail", "excluded"], { name: "Sample Student", email: "student@example.com", phone: "9999999999", password: "Password@123", role: "Student", regno: "BT26001", academicyear: "2026-27", admissionyear: "2026-27", regulation: "R2026", program: "B.Tech", programcode: "BT001", semester: "1", section: "A", fathername: "Father Name", mothername: "Mother Name", dateofbirth: "2008-01-01", category: "General", gender: "Female", nationality: "Indian", address: "Address", state: "State", pincode: "462001", googleemail: "student@gmail.com", excluded: "No" })
];
